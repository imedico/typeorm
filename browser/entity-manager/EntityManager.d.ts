...
export declare class EntityManager {
     ...
     */
    find<Entity extends ObjectLiteral>(entityClass: EntityTarget<Entity>, options?: FindManyOptions<Entity>, timestamp?: Date): Promise<Entity[]>;
    /**
     * Finds entities that match given find options.
     */
     ...
     * @param timestamp get datasets from this timestamp (temporal tables)
     */
    findOne<Entity extends ObjectLiteral>(entityClass: EntityTarget<Entity>, options: FindOneOptions<Entity>, timestamp?: Date): Promise<Entity | null>;
    /**
