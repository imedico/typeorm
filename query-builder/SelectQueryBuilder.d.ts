...
export declare class SelectQueryBuilder<Entity extends ObjectLiteral> extends QueryBuilder<Entity> implements WhereExpressionBuilder {
     ...
     */
    getRawMany<T = any>(timestamp?: Date): Promise<T[]>;
    /**
     * Executes sql generated by query builder and returns object with raw results and entities created from them.
     * @param timestamp get datasets from this timestamp (temporal tables)
     */
    getRawAndEntities<T = any>(timestamp?: Date): Promise<{
        entities: Entity[];
        raw: T[];
    }>;
    /**
     ...
     * @param timestamp get datasets from this timestamp (temporal tables)
     */
    getOne(timestamp?: Date): Promise<Entity | null>;
    /**
     ...
     * @param timestamp get datasets from this timestamp (temporal tables)
     */
    getMany(timestamp?: Date): Promise<Entity[]>;
    /**
     ...
     * @param timestamp get datasets from this timestamp (temporal tables)
     */
    protected executeEntitiesAndRawResults(queryRunner: QueryRunner, timestamp?: Date): Promise<{
        entities: Entity[];
        raw: any[];
    }>;
     ...
     */
    protected loadRawResults(queryRunner: QueryRunner, timestamp?: Date): Promise<any>;
    /**
