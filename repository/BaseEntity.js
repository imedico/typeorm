...
class BaseEntity {
     ...
     */
    static findAt(timestamp, options) {
        return this.getRepository().findAt(timestamp, options);
    }
    /**
     * Finds entities that match given WHERE conditions.
     */
     ...
     * Finds first entity that matches given conditions.
     */
    static findOneAt(timestamp, options) {
        return this.getRepository().findOneAt(timestamp, options);
    }
    /**
     * Finds first entity that matches given conditions.
     */
