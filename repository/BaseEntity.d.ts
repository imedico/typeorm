...
export declare class BaseEntity {
     ...
     */
    static findAt<T extends BaseEntity>(this: {
        new (): T;
    } & typeof BaseEntity, timestamp: Date, options?: FindManyOptions<T>): Promise<T[]>;
    /**
     * Finds entities that match given WHERE conditions.
     */
     ...
     * Finds first entity that matches given conditions.
     */
    static findOneAt<T extends BaseEntity>(this: {
        new (): T;
    } & typeof BaseEntity, timestamp: Date, options: FindOneOptions<T>): Promise<T | null>;
    /**
     * Finds first entity that matches given conditions.
     */
